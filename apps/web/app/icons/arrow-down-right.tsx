...
export interface ArrowDownRightIconHandle extends IconAnimationHandle {}
interface ArrowDownRightIconProps extends HTMLAttributes<HTMLDivElement> {
	size?: number;
	ref?: Ref<ArrowDownRightIconHandle>;
}

const ARROW_DOWN_RIGHT_VARIANTS: Variants = {
	normal: {
		x: 0,
		y: 0,
	},
	...
	return (
		...
		>
			...
			>
				<motion.path
					animate={controls}
					variants={ARROW_DOWN_RIGHT_VARIANTS}
					strokeLinecap="round"
