...
export interface BadgeAlertIconHandle extends IconMotionHandle {}
...
const BADGE_ALERT_ROTATE_VARIANTS = v(
	rotate(0, [0, 360]),
	withTransition({
		duration: 1.6,
		ease: "linear",
	...
	return (
		...
		>
			...
			>
				<motion.path
					animate={controls}
					variants={BADGE_ALERT_ROTATE_VARIANTS}
				...
				/>
				<path d="M12 8V12M12.125 15.75H12M12.25 15.75C12.25 15.8881 12.1381 16 12 16C11.8619 16 11.75 15.8881 11.75 15.75C11.75 15.6119 11.8619 15.5 12 15.5C12.1381 15.5 12.25 15.6119 12.25 15.75Z" />
			</svg>
		</div>
	);
};
